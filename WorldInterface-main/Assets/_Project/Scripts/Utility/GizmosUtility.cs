...
namespace WorldInterface
{
    public static class GizmosUtility
    {
        ...
        public static void DrawBoxCast(
            Vector3 center, Vector3 halfExtents, Vector3 direction, Quaternion orientation, float maxDistance,
            bool showCast = false)
        {
            DrawBoxCast(center, center + direction * maxDistance, 2 * halfExtents, orientation,
                Physics.DefaultRaycastLayers, showCast);
        }
            ...
            int layerMask, bool showCast)
        {
            ...
            if (showCast && Physics.BoxCast(center, halfExtents, direction, out var hitInfo, orientation, maxDistance,
                    layerMask))
            {
            ...
            Gizmos.DrawLine(center - halfExtentsX - halfExtentsY - halfExtentsZ,
                end - halfExtentsX - halfExtentsY - halfExtentsZ);
            Gizmos.DrawLine(center + halfExtentsX - halfExtentsY - halfExtentsZ,
                end + halfExtentsX - halfExtentsY - halfExtentsZ);
            Gizmos.DrawLine(center - halfExtentsX + halfExtentsY - halfExtentsZ,
                end - halfExtentsX + halfExtentsY - halfExtentsZ);
